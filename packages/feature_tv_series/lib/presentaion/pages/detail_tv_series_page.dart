      ...
      body: BlocConsumer<TvSeriesDetailCubit, TvSeriesDetailState>(
        ...
        builder: (context, state) {
          return state.when(
            ...
            loaded: (tvSeries, recommendations, isAdded, message) {
              return SafeArea(
                child: DetailContent(tvSeries, recommendations, isAdded),
              );
            },
...
class DetailContent extends StatelessWidget {
                          ...
                          children: [
                            ...
                            FilledButton(
                              onPressed: () async {
                                ...
                                await cubit.loadWatchlistStatus(tvSeries.id);
                              },
                              child: Row(
                            ...
                            Text(_showRuntime(tvSeries.episodeRunTime)),
                            Row(
                              children: [
                                RatingBarIndicator(
  ...
  String _showRuntime(List<int> runtime) {
    if (runtime.isEmpty) return 'N/A';
    final int minutes = runtime.first;
