...
// in feature_watchlist/test/presentation/cubit/watchlist_cubit_test.dart.
...
/// A class which mocks [GetWatchlistTvSeriesUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetWatchlistTvSeriesUseCase extends _i1.Mock
    implements _i7.GetWatchlistTvSeriesUseCase {
  MockGetWatchlistTvSeriesUseCase() {
    _i1.throwOnMissingStub(this);
  }
